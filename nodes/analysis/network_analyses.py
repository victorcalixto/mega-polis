...
AnalysisMethod = namedtuple(
    'AnalysisMethod', ['closeness_centrality', 'betweenness_centrality', 'degree_centrality', 'basic']
)
ANALYSISMETHOD = AnalysisMethod(
    'closeness_centrality', 'betweenness_centrality', 'degree_centrality', 'basic'
)
...
class SvMegapolisNetworkAnalyses(SverchCustomTreeNode, bpy.types.Node):
    ...
    Tooltip: Network Analyses: Closeness Centrality and Degree Centrality
    """
